...
class TestRectangle(unittest.TestCase):
    ...
    def setUp(self):
        '''check 01: imports module, instantiates class'''
        Base._Base__nb_objects = 0

    def tearDown(self):
        '''check 02: Cleans up after each test_method.'''
        pass

    # ----------------- #2 ------------------------

    def test_A_class(self):
        '''check 03: Rectangle class type.'''
        self.assertEqual(str(Rectangle),
                         "<class 'models.rectangle.Rectangle'>")

    def test_B_inheritance(self):
        '''check 04: if Rectangle inherits Base.'''
        self.assertTrue(issubclass(Rectangle, Base))

    def test_C_constructor_no_args(self):
        '''check 05: constructor signature.'''
...
and 'height'"
    ...
    def test_C_constructor_many_args(self):
        '''check 06: constructor signature.'''
        with self.assertRaises(TypeError) as e:
...
given"
    ...
    def test_C_constructor_one_args(self):
        '''check 07: constructor signature.'''
        with self.assertRaises(TypeError) as e:
            r = Rectangle(1)
    ...
    def test_D_instantiation_positional(self):
        '''check 09: positional instantiation.'''
    ...
    def test_D_instantiation_keyword(self):
        '''check 10: positional instantiation.'''
    ...
    def test_E_id_inherited(self):
        '''check 11: if id is inherited from Base.'''
        Base._Base__nb_objects = 98
        r = Rectangle(2, 4)
        self.assertEqual(r.id, 99)

    def test_F_properties(self):
        '''check 12: property get/set.'''
        r = Rectangle(5, 9)
        r.width = 100
        r.height = 101
        r.x = 102
    ...
    def test_J_display_simple(self):
        '''check 23: display() method output.'''
        r = Rectangle(1, 1)
        f = io.StringIO()
...
"""
    ...
    def test_K_str(self):
        '''check 25: __str__() method return.'''
        r = Rectangle(5, 2)
    ...
    def test_L_update_args(self):
        '''check 27: update() postional arguments.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_args_bad(self):
        '''check 28: update() positional arguments fubars.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_kwargs(self):
        '''check 29: update() keyword arguments.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_kwargs_2(self):
        '''check 30: update() keyword arguments.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
