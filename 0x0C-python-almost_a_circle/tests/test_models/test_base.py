...
class TestBase(unittest.TestCase):
    ...
    def setUp(self):
        '''check 01: imports module, init class'''
        Base._Base__nb_objects = 0
        pass

    def tearDown(self):
        '''check 02: clean up after test_method.'''
        pass

    def test_A_nb_objects_private(self):
        '''check 03: if nb_objects is private class attribute.'''
        self.assertTrue(hasattr(Base, "_Base__nb_objects"))

    def test_B_nb_objects_initialized(self):
        '''check 04: if nb_objects = 0.'''
    ...
    def test_D_constructor_args_2(self):
        '''check 07: fabricator signature (2 notself arguments).'''
        with self.assertRaises(TypeError) as e:
...
were given"
    ...
    def test_G_custom_id_int(self):
        '''check 11: custom integer id.'''
        i = 98
        b = Base(i)
        self.assertEqual(b.id, i)

    def test_G_custom_id_str(self):
        '''check 12: custom string id.'''
        i = "FooBar"
        b = Base(i)
        self.assertEqual(b.id, i)

    def test_G_id_keyword(self):
        '''check 13: id as keyword argument.'''
        i = 421
        b = Base(id=i)
        self.assertEqual(b.id, i)
    ...
    def test_H_to_json_string(self):
        '''check 14: to_json_string() signature:'''
        with self.assertRaises(TypeError) as e:
            Base.to_json_string()
...
'list_dictionaries'"
    ...
    def test_H_test_from_json_string(self):
        '''check 15: to_json_string() signature:'''
        with self.assertRaises(TypeError) as e:
...
"height": 34340}]'
    ...
    def test_K_load_from_file(self):
        '''check 18: load_from_file() method.'''
        r1 = Rectangle(10, 7, 2, 8)
        r2 = Rectangle(2, 4)
        list_in = [r1, r2]
