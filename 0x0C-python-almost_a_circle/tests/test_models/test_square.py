...
class TestSquare(unittest.TestCase):
    ...
    def setUp(self):
        '''check: Imports module, instantiates class'''
        Base._Base__nb_objects = 0

    def tearDown(self):
        '''check: Cleans up after each test_method.'''
        pass

    # ----------------- #2 ------------------------

    def test_A_class(self):
        '''check: Square class type.'''
        self.assertEqual(str(Square),
                         "<class 'models.square.Square'>")

    def test_B_inheritance(self):
        '''check: if Square inherits Base.'''
...
were given"
    ...
    def test_D_instantiation_positional(self):
        '''check: positional instantiation.'''
        r = Square(5, 10, 15)
    ...
    def test_E_id_inherited(self):
        '''check: if id is inherited from Base.'''
        Base._Base__nb_objects = 98
        r = Square(2)
        self.assertEqual(r.id, 99)

    def test_F_properties(self):
        '''check: property getters/setters.'''
        r = Square(5, 9)
        r.size = 98
        r.x = 102
        r.y = 103
    ...
    def invalid_types(self):
        '''check: tuple of types for validation.'''
    ...
    def test_J_display_no_args(self):
        '''check: display() method signature.'''
        r = Square(9)
        with self.assertRaises(TypeError) as e:
            Square.display()
...
"""
    ...
    def test_K_str_no_args(self):
        '''check: __str__() method signature.'''
        r = Square(5, 2)
        with self.assertRaises(TypeError) as e:
            Square.__str__()
    ...
    def test_L_update_args_bad(self):
        '''check: update() positional arg fubars.'''
        r = Square(5, 2)
        d = r.__dict__.copy()
